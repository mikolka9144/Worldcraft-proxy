...
public class WorldBuilder implements HttpDownloadInterceptor {
    ...
    public void getWorld(WorldDownloadRequest request) {
        ...
        trn.enumerateWorld3D(v -> trn.at(v).setBlockLight( 1).setSkyLight( 1));

        trn.at(2,4,2).setBlockType(BlockType.AIR);
        trn.at(2,3,2).setBlockType(BlockType.AIR); //emitter
        trn.at(2,2,2).setBlockLight(15).setBlock(BlockType.SLAB_ID.getId());
        trn.at(5,3,5).setBlockLight(15).setBlock(BlockType.AIR.getId()); // emitter
        ...
        trn.at(9,10,10).setBlockLight(15);
        trn.at(11,10,10).setBlockLight(15);
        trn.at(10,10,9).setBlockLight(15);
        trn.at(10,10,11).setBlockLight(15);
        trn.at(10,9,10).setSkyLight(15);
        //
